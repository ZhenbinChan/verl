...
"""Algorithm configuration dataclasses for DAPO and related algorithms."""
...
class AlgoConfig:
    ...
    Args:
        ...
        mask_format_error_advantage (bool): Whether to zero advantages for samples penalized only for format errors.
    ...
    mask_format_error_advantage: bool = False
