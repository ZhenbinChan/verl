...
EXPERIMENT_NAME='qwen3-8b_logiqa_grpo_baseline_wothk'
N_GPUS_PER_NODE=4
BATCH_SIZE=16
ROLLOUT_N=16
TEMPERATURE=0.8
TOP_P=1.0
PROMPT_PATH=$HOME/prompts/base.txt # 不使用 Action
REWARD_MANAGER='naive_plus' # 使用普通的 Reward manager
REWARD_STYLE='null'
LOG_FORMAT_METRICS=True # 可以开着
FORMAT_PENALTY=False # 为了保证不影响，设置为 False
THINK_MODE=False
