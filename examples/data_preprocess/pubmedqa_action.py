...
"""
Preprocess the PubMedQA dataset to parquet format
"""
...
if __name__ == "__main__":
    ...
    parser.add_argument("--local_dir", default="./data/pubmedqa_action/")
    ...
    dataset = datasets.load_dataset(data_source, "pqa_aritifical")# ["pqa_labeled", "pqa_unlabeled"]
