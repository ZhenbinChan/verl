...
# GSPO Training Configuration
# Group Policy Optimization with Sequence-level Importance Sampling
# Reference: https://arxiv.org/pdf/2507.18071

python3 -m verl.trainer.main_ppo \
    # GSPO uses GRPO advantage but different policy loss
    algorithm.adv_estimator=grpo \
    # GSPO-specific: Filter Groups (Dynamic Sampling)
    ...
    # GSPO-specific: seq-mean-token-mean loss aggregation (recommended)
    ...
    trainer.experiment_name='Qwen2.5-1.5B_GSPO_Reclor' \
