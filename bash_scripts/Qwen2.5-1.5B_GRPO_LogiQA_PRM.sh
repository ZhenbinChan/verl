...
PRM_PATH=/home/chenzhb/Workspaces/LLMs/PURE-PRM-7B

python3 -m verl.trainer.main_ppo \
    algorithm.adv_estimator=grpo \
    data.train_files=$HOME/data/logiqa2k/train.parquet \
    data.val_files=$HOME/data/logiqa2k/test.parquet \
    ...
    reward_model.reward_manager='prm' \
    ...
    trainer.experiment_name='Qwen2.5-1.5B_GRPO_LogiQA_epoch10_PRM' \
