...
python3 -m verl.trainer.main_ppo \
    ...
    data.train_files=$HOME/data/logiqa2_reclor_action/train.parquet \
    data.val_files=$HOME/data/logiqa2_reclor_action/test.parquet \
    ...
    trainer.experiment_name='Qwen2.5-7B_GRPO_LogiQA_Reclor' \
    trainer.rollout_data_dir=$HOME/homogeneous_data \
