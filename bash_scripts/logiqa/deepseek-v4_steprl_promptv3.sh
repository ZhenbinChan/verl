...
EXPERIMENT_NAME='qwen3-8b_steprl_originv2_deepseek_rm'
...
CUDA_VISIBLE_DEVICES=0,1,2,3 python3 -m verl.trainer.main_ppo \
	    ...
	    +trainer.step_treerl_config.trajectory_rm_url=https://genaiapi.shanghaitech.edu.cn/api/v1 \
	    +trainer.step_treerl_config.trajectory_rm_model=deepseek-pro \
	    +trainer.step_treerl_config.trajectory_rm_api_key=f7f4b08f3abf4632afdb26baacbfb76e \
